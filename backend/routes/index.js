...
projectRoutes.put('/project/:id', async (req, res) => {
    // validate type 
    const project = joi.object({
        title: joi.string().min(3).max(100).required(),
        description: joi.string().required(),
...
projectRoutes.post('/project/:id/task', async (req, res) => {
...
projectRoutes.get('/project/:id/task/:taskId', async (req, res) => {
...
projectRoutes.put('/project/:id/todo', async (req, res) => {
    let todo = []
...
// projectRoutes.use('/project/:id/task', async (req, res, next) => {
...
// projectRoutes.get('/project/:id/task/:taskId', (req, res) => {
//     res.send(req.params)
// })
